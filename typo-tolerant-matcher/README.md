...
- [Technical Report](TECHNICAL_REPORT.md) — detailed analysis, CNN vs Transformer comparison, design decisions
- [Data Documentation](docs/DATA.md) — data sources, generation process, preprocessing
